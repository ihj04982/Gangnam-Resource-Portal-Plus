...
export const getFluorescentBattery = async (
  page = 1,
  perPage = 10,
): Promise<LocationApiResponse<FluorescentBatteryLocation>> => {
...
export const getWasteBag = async (page = 1, perPage = 10): Promise<LocationApiResponse<WasteBagLocation>> => {
...
export const getCigaretteButt = async (page = 1, perPage = 10): Promise<LocationApiResponse<CigaretteButtLocation>> => {
...
export const getClothingCollection = async (
  page = 1,
  perPage = 10,
): Promise<LocationApiResponse<ClothingCollectionLocation>> => {
